...
const AbsouluteCard = () => {
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 justify-self-center lg:justify-items-center gap-6 md:gap-20 lg:gap-44 p-6 rounded-2xl bg-white lg:absolute -bottom-64 mx-20 my-6 lg:my-0 left-0 right-0 ">
            <div>
