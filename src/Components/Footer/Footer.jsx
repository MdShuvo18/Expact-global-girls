        ...
        <footer className="mt-24 bg-white">
            <div className="flex  mx-32 gap-16">
                <div className="space-y-7">
                    ...
                    <h1 className="w-2/3">Scan a Turning Hearts Medallion to learn about and interact with those who have passed on. You can also begin documenting the legacy you wish to leave behind.</h1>
